...
public class overloading {
    ...
    public static void main (String args[]) {
        ...
        System.out.println("Masukan Pekerjaan : Marketing");
        System.out.println("Masukan Alamat Kantor : Fatmawati");
        System.out.println("------------------o0o-----------------------");
        System.out.println("*** Data Status ***");
        System.out.println("Masukan Status : Menikah");
        System.out.println("Masukan Nama Suami/Istri : Sisilin");
        System.out.println("Masukan Jumlah Anak : 2");
